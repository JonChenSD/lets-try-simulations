      ...
      return function(t) {
        ...
        const _t = (t2, e2, s2, n2, i2) => {
          ...
          const l2 = L(t2), p2 = await ((t3, e3) => {
            ...
            return b(s3, n3);
          })(s2, t2), d2 = mt(n2.numberOfInputs, n2.channelCount), f2 = mt(n2.numberOfOutputs, i2), _2 = Array.from(t2.parameters.keys()).reduce((t3, e3) => __spreadProps(__spreadValues({}, t3), { [e3]: new Float32Array(128) }), {});
        ...
        const Ye = ((t2, e2, s2, n2, i2, o2) => class extends t2 {
          constructor(t3, s3) {
            const r2 = i2(t3), a2 = __spreadValues(__spreadValues({}, M), s3), c2 = n2(r2, a2);
        ...
        const ts = ((t2, e2) => (s2) => {
          ...
          return class h2 {
            constructor(h3) {
              ...
              const { length: u2, numberOfChannels: l2, sampleRate: p2 } = __spreadValues(__spreadValues({}, I), h3);
        ...
        const fs = ((t2, e2, s2, n2, i2, o2, r2, a2) => class extends t2 {
          constructor(t3, n3) {
            const a3 = o2(t3), c2 = __spreadValues(__spreadValues({}, j), n3), h2 = i2(a3, c2), u2 = r2(a3), l2 = u2 ? e2() : null;
          ...
          constructor(t2, e2) {
            const s2 = Ss(t2), n2 = __spreadValues(__spreadValues({}, vt), e2), i2 = Ts(s2, n2), o2 = ks(s2);
        ...
        const Es = ((t2, e2) => (s2, n2) => {
          ...
          constructor(t3, o2) {
            const r2 = n2(t3), a2 = __spreadValues(__spreadValues({}, yt), o2);
          ...
          constructor(t3, r2) {
            const a2 = n2(t3), c2 = o2(__spreadValues(__spreadValues({}, xt), r2));
        ...
        })(Wt, st, Oe), Wt, Fe, Ne, (t2) => __spreadProps(__spreadValues({}, t2), { channelCount: t2.numberOfOutputs })), Fs = ((t2, e2, s2, n2) => (i2, _a2) => {
          var _b = _a2, { offset: o2 } = _b, r2 = __objRest(_b, ["offset"]);
          const a2 = i2.createBuffer(1, 2, 44100), c2 = e2(i2, { buffer: null, channelCount: 2, channelCountMode: "max", channelInterpretation: "speakers", loop: false, loopEnd: 0, loopStart: 0, playbackRate: 1 }), h2 = s2(i2, __spreadProps(__spreadValues({}, r2), { gain: o2 })), u2 = a2.getChannelData(0);
          ...
          constructor(t3, r3) {
            const a2 = i2(t3), c2 = __spreadValues(__spreadValues({}, wt), r3), h2 = n2(a2, c2), u2 = o2(a2), l2 = u2 ? s2() : null;
          ...
          constructor(t3, r2) {
            const a2 = n2(t3), c2 = __spreadValues(__spreadValues({}, bt), r2), h2 = s2(a2, c2);
          ...
          constructor(t3, a2) {
            const c2 = i2(t3), h2 = __spreadValues(__spreadValues({}, Tt), a2), u2 = n2(c2, h2), l2 = o2(c2);
        ...
        const Bs = ((t2, e2, s2, n2, i2, o2, r2, a2) => class extends t2 {
          constructor(t3, i3) {
            const c2 = o2(t3), h2 = __spreadValues(__spreadValues({}, kt), i3), u2 = n2(c2, h2), l2 = r2(c2);
          ...
          constructor(t3, r2) {
            const a2 = i2(t3), c2 = __spreadValues(__spreadValues({}, Ct), r2), h2 = n2(a2, c2), u2 = o2(a2);
        ...
        const Xs = ((t2, e2, s2, n2, i2, o2) => class extends t2 {
          constructor(t3, r2) {
            const a2 = n2(t3), c2 = i2(a2), h2 = __spreadValues(__spreadValues({}, Ot), r2), u2 = e2(a2, c2 ? null : t3.baseLatency, h2);
          ...
          constructor(t3, r3) {
            const a2 = i2(t3), c2 = __spreadValues(__spreadValues({}, Jt), r3), h2 = s2(a2, c2), u2 = o2(a2), l2 = u2 ? n2() : null, p2 = t3.sampleRate / 2;
        ...
        var en;
        const sn = ((t2, e2, s2, n2, i2) => (o2, _a2) => {
          var _b = _a2, { curve: r2, oversample: a2 } = _b, c2 = __objRest(_b, ["curve", "oversample"]);
          const h2 = o2.createWaveShaper(), u2 = o2.createWaveShaper();
          It(h2, c2), It(u2, c2);
          const l2 = s2(o2, __spreadProps(__spreadValues({}, c2), { gain: 1 })), p2 = s2(o2, __spreadProps(__spreadValues({}, c2), { gain: -1 })), d2 = s2(o2, __spreadProps(__spreadValues({}, c2), { gain: 1 })), f2 = s2(o2, __spreadProps(__spreadValues({}, c2), { gain: -1 }));
        ...
        })(tn, At, sn, ie, As, Be, oe), on = ((t2, e2, s2, n2, i2, o2, r2, a2, c2) => (h2, _a2) => {
          var _b = _a2, { coneInnerAngle: u2, coneOuterAngle: l2, coneOuterGain: p2, distanceModel: d2, maxDistance: f2, orientationX: _2, orientationY: m2, orientationZ: g2, panningModel: v2, positionX: y2, positionY: x2, positionZ: w2, refDistance: b2, rolloffFactor: T2 } = _b, S2 = __objRest(_b, ["coneInnerAngle", "coneOuterAngle", "coneOuterGain", "distanceModel", "maxDistance", "orientationX", "orientationY", "orientationZ", "panningModel", "positionX", "positionY", "positionZ", "refDistance", "rolloffFactor"]);
          ...
          if (S2.channelCountMode === "max")
            throw r2();
          It(k2, S2);
          const C2 = { channelCount: 1, channelCountMode: "explicit", channelInterpretation: "discrete" }, A2 = s2(h2, __spreadProps(__spreadValues({}, C2), { channelInterpretation: "speakers", numberOfInputs: 6 })), D2 = n2(h2, __spreadProps(__spreadValues({}, S2), { gain: 1 })), O2 = n2(h2, __spreadProps(__spreadValues({}, C2), { gain: 1 })), M2 = n2(h2, __spreadProps(__spreadValues({}, C2), { gain: 0 })), E2 = n2(h2, __spreadProps(__spreadValues({}, C2), { gain: 0 })), R2 = n2(h2, __spreadProps(__spreadValues({}, C2), { gain: 0 })), q2 = n2(h2, __spreadProps(__spreadValues({}, C2), { gain: 0 })), F2 = n2(h2, __spreadProps(__spreadValues({}, C2), { gain: 0 })), I2 = i2(h2, 256, 6, 1), V2 = o2(h2, __spreadProps(__spreadValues({}, C2), { curve: new Float32Array([1, 1]), oversample: "none" }));
        ...
        const cn = ((t2, e2, s2, n2, i2, o2, r2) => class extends t2 {
          constructor(t3, a2) {
            const c2 = i2(t3), h2 = __spreadValues(__spreadValues({}, Kt), a2), u2 = s2(c2, h2), l2 = o2(c2);
          ...
          return { render(p2, d2, f2) {
            ...
            return _2 !== void 0 ? Promise.resolve(_2) : (async (p3, d3, f3) => {
              ...
              const g2 = { channelCount: m2.channelCount, channelCountMode: m2.channelCountMode, channelInterpretation: m2.channelInterpretation }, v2 = __spreadProps(__spreadValues({}, g2), { coneInnerAngle: m2.coneInnerAngle, coneOuterAngle: m2.coneOuterAngle, coneOuterGain: m2.coneOuterGain, distanceModel: m2.distanceModel, maxDistance: m2.maxDistance, panningModel: m2.panningModel, refDistance: m2.refDistance, rolloffFactor: m2.rolloffFactor }), y2 = E(m2, d3);
              if ("bufferSize" in m2)
                _3 = n2(d3, __spreadProps(__spreadValues({}, g2), { gain: 1 }));
              else if (!y2) {
                const t3 = __spreadProps(__spreadValues({}, v2), { orientationX: m2.orientationX.value, orientationY: m2.orientationY.value, orientationZ: m2.orientationZ.value, positionX: m2.positionX.value, positionY: m2.positionY.value, positionZ: m2.positionZ.value });
                m2 = i2(d3, t3);
              }
              if (u2.set(d3, _3 === null ? m2 : _3), _3 !== null) {
                ...
                const t3 = await l2, o3 = n2(d3, __spreadProps(__spreadValues({}, g2), { gain: 1 }));
                await c2(p3, d3, o3, f3);
                const u3 = [];
                for (let e3 = 0; e3 < t3.numberOfChannels; e3 += 1)
                  u3.push(t3.getChannelData(e3));
                let m3 = [u3[0][0], u3[1][0], u3[2][0]], y3 = [u3[3][0], u3[4][0], u3[5][0]], x2 = n2(d3, __spreadProps(__spreadValues({}, g2), { gain: 1 })), w2 = i2(d3, __spreadProps(__spreadValues({}, v2), { orientationX: m3[0], orientationY: m3[1], orientationZ: m3[2], positionX: y3[0], positionY: y3[1], positionZ: y3[2] }));
                ...
                for (let e3 = 128; e3 < t3.length; e3 += 128) {
                  ...
                  if (t4.some((t5, e4) => t5 !== m3[e4]) || s3.some((t5, e4) => t5 !== y3[e4])) {
                    ...
                    x2.gain.setValueAtTime(0, r3), x2 = n2(d3, __spreadProps(__spreadValues({}, g2), { gain: 0 })), w2 = i2(d3, __spreadProps(__spreadValues({}, v2), { orientationX: m3[0], orientationY: m3[1], orientationZ: m3[2], positionX: y3[0], positionY: y3[1], positionZ: y3[2] })), x2.gain.setValueAtTime(1, r3), o3.connect(x2).connect(w2.inputs[0]), w2.connect(_3);
                  }
                }
                return _3;
              }
          ...
          constructor(i3, o2) {
            const r2 = e2(i3), a2 = n2(__spreadValues(__spreadValues({}, te), o2)), c2 = t2(r2, a2);
            return s2.add(c2), c2;
          }
          ...
          return e2 === void 0 ? s2 === void 0 ? __spreadProps(__spreadValues({}, t2), { imag: [0, 0], real: [0, 0] }) : __spreadProps(__spreadValues({}, t2), { imag: Array.from(s2, () => 0), real: s2 }) : s2 === void 0 ? __spreadProps(__spreadValues({}, t2), { imag: e2, real: Array.from(e2, () => 0) }) : __spreadProps(__spreadValues({}, t2), { imag: e2, real: s2 });
        }), un = ((t2, e2) => (s2, n2) => {
          ...
          const r2 = new Float32Array([1, 1]), a2 = Math.PI / 2, c2 = { channelCount: 1, channelCountMode: "explicit", channelInterpretation: "discrete" }, h2 = __spreadProps(__spreadValues({}, c2), { oversample: "none" }), u2 = (t3, o3, u3, l2, p2) => {
            if (o3 === 1)
              return ((t4, e3, i3, o4) => {
                ...
                const p3 = s2(t4, __spreadProps(__spreadValues({}, c2), { gain: 0 })), d2 = n2(t4, __spreadProps(__spreadValues({}, h2), { curve: u4 })), f2 = n2(t4, __spreadProps(__spreadValues({}, h2), { curve: r2 })), _2 = s2(t4, __spreadProps(__spreadValues({}, c2), { gain: 0 })), m2 = n2(t4, __spreadProps(__spreadValues({}, h2), { curve: l3 }));
                return { connectGraph() {
            ...
            if (o3 === 2)
              return ((t4, i3, o4, u4) => {
                ...
                const m2 = e2(t4, { channelCount: 2, channelCountMode: "explicit", channelInterpretation: "discrete", numberOfOutputs: 2 }), g2 = s2(t4, __spreadProps(__spreadValues({}, c2), { gain: 0 })), v2 = n2(t4, __spreadProps(__spreadValues({}, h2), { curve: l3 })), y2 = s2(t4, __spreadProps(__spreadValues({}, c2), { gain: 0 })), x2 = n2(t4, __spreadProps(__spreadValues({}, h2), { curve: p3 })), w2 = n2(t4, __spreadProps(__spreadValues({}, h2), { curve: r2 })), b2 = s2(t4, __spreadProps(__spreadValues({}, c2), { gain: 0 })), T2 = n2(t4, __spreadProps(__spreadValues({}, h2), { curve: d2 })), S2 = s2(t4, __spreadProps(__spreadValues({}, c2), { gain: 0 })), k2 = n2(t4, __spreadProps(__spreadValues({}, h2), { curve: f2 }));
                return { connectGraph() {
          ...
          return (e3, _a2) => {
            var _b = _a2, { channelCount: n3, channelCountMode: r3, pan: a3 } = _b, c3 = __objRest(_b, ["channelCount", "channelCountMode", "pan"]);
            if (r3 === "max")
              throw i2();
            const h3 = t2(e3, __spreadProps(__spreadValues({}, c3), { channelCount: 1, channelCountMode: r3, numberOfInputs: 2 })), l2 = s2(e3, __spreadProps(__spreadValues({}, c3), { channelCount: n3, channelCountMode: r3, gain: 1 })), p2 = s2(e3, { channelCount: 1, channelCountMode: "explicit", channelInterpretation: "discrete", gain: a3 });
          ...
          constructor(t3, r2) {
            const a2 = i2(t3), c2 = __spreadValues(__spreadValues({}, ee), r2), h2 = s2(a2, c2), u2 = o2(a2);
          ...
          constructor(t3, e3) {
            const a2 = i2(t3), c2 = __spreadValues(__spreadValues({}, ne), e3), h2 = s2(a2, c2);
          ...
          createPeriodicWave(t3, e3, s3 = { disableNormalization: false }) {
            return new g2(this, __spreadProps(__spreadValues({}, s3), { imag: e3, real: t3 }));
          }
          createStereoPanner() {
            return new v2(this);
          }
          ...
          constructor(t3, i2) {
            ...
            if (n2(o2))
              throw new TypeError();
            const r2 = __spreadValues(__spreadValues({}, Et), i2), a2 = e2(o2, r2);
        ...
        const En = ((t2) => (e2, s2, n2 = 0, i2 = 0) => {
          ...
          const W2 = mt(g2.numberOfInputs, g2.channelCount), G2 = mt(g2.numberOfOutputs, v2), U2 = _2.parameterDescriptors === void 0 ? [] : _2.parameterDescriptors.reduce((t3, { name: e3 }) => __spreadProps(__spreadValues({}, t3), { [e3]: new Float32Array(128) }), {});
          let Q2 = true;
          const Z2 = () => {
                ...
                if (t3[0] === "processorerror") {
                  ...
                  if (e4 !== null) {
                    ...
                    s3 !== void 0 ? t3[1] = s3 : (t3[1] = (s4) => {
                      s4.type === "error" ? (Object.defineProperties(s4, { type: { value: "processorerror" } }), e4(s4)) : e4(new ErrorEvent(t3[0], __spreadValues({}, s4)));
                    }, n3.set(e4, t3[1]));
                  }
                }
          ...
          constructor(e3, p3, d2) {
            var f2;
            const m2 = a2(e3), g2 = c2(m2), v2 = u2(__spreadValues(__spreadValues({}, dt), d2)), y2 = _.get(m2), x2 = y2 == null ? void 0 : y2.get(p3), w2 = g2 || m2.state !== "closed" ? m2 : (f2 = r2(m2)) !== null && f2 !== void 0 ? f2 : m2, b2 = i2(w2, g2 ? null : e3.baseLatency, h2, p3, x2, v2);
        ...
        })(On, Ze, ps, Pn, Nn, L, jn, Fe, Ne, vn, (t2) => __spreadProps(__spreadValues({}, t2), { outputChannelCount: t2.outputChannelCount !== void 0 ? t2.outputChannelCount : t2.numberOfInputs === 1 && t2.numberOfOutputs === 1 ? [t2.channelCount] : Array.from({ length: t2.numberOfOutputs }, () => 1) }), Ln, de) : void 0, Bn = (((t2, e2, s2, n2, i2) => {
          ...
          constructor(t3, s3, i3) {
            ...
            const { length: r2, numberOfChannels: a2, sampleRate: c2 } = __spreadValues(__spreadValues({}, $t), o2), h2 = n2(a2, r2, c2);
...
var Tone = __toModule(require_Tone());
var notes = ["C", "C#", "D", "D#", "E", "F", "G", "G#", "A", "A#", "B"];
var now2 = Tone.now();
...
var trumpet = new Tone.Sampler({
  ...
  baseUrl: "./assets/",
  onload: () => {
    trumpet.triggerAttackRelease(["C1", "E1", "G1", "B1"], 0.8);
  }
}).toDestination();
var banjo = new Tone.Sampler({
  urls: {
    C2: "banjo.mp3"
  },
  baseUrl: "./assets/",
...
var dog = new Tone.Player("./assets/bark.mp3").toDestination();
Tone.loaded().then(() => {
  dog.start();
});
Tone.start();
var player = {
  init: function() {
    var _a;
    (_a = document.querySelector("button")) == null ? void 0 : _a.addEventListener("click", async () => {
      await Tone.start();
  ...
  play: function(type, x, y) {
    ...
    switch (type) {
      ...
      case "banjo":
        note = notes[y % 11];
        banjo.triggerAttackRelease(note + 2, 1);
        break;
      case "guitar":
        note = notes[y % 11];
      ...
      case "marimba":
        note = notes[y % 11];
        marimba.triggerAttackRelease(note + 2, 1);
        break;
      case "xylophone":
        note = notes[y % 11];
        xylophone.triggerAttackRelease(note + 2, 1);
        break;
      case "dog":
...
var arrow_default = determineArrowDirection;

// src/main.js
var arrowTypes = ["\u2190", "\u2192", "\u2191", "\u2193", "\u2196", "\u2197", "\u2198", "\u2199"];
var spinnerTypes = ["\u2502", "\u27CB", "\u2015", "\u27CD"];
var agentTypes = ["\u{1F415}", "\u{1F98C}", "\u{1F402}"];
var obstacleTypes = ["\u{1F415}", "\u{1F98C}", "\u{1F402}", "\u21C8"];
var actionBlocksTypes = ["\u21E6", "\u21E7", "\u21E8", "\u21E9", "\u21D0", "\u21D1", "\u21D2", "\u21D3"];
...
function randomizeGrid() {
  ...
  for (let x = 0; x < canvasW / boxWH; x += 1) {
    arrayOfBoxes.push([]);
    for (let y = 0; y < canvasW; y += boxWH) {
      if (Math.floor(Math.random() * document.getElementById("randomInterval").value * 0.4) === 0) {
...
function agentCheckSpace(tempArray, agent, x, y, adjustX, adjustY) {
  let tempi;
  let tempj;
  if (actionBlocksTypes.includes(tempArray[x][y]) && agent == "\u{1F402}") {
  ...
  for (let y = 0; y < tempArray.length; y += 1) {
    for (let x = 0; x < tempArray.length; x += 1) {
      ...
      if (typeof tempArrayAgents[x][y] === "string") {
        ...
        if (currentAgent == "\u{1F98C}") {
          console.log("FOUND LAMA");
        }
        if (currentAgent == "\u{1F415}") {
          console.log("FOUND LAMA");
        }
        if (agentTypes.includes(currentAgent)) {
          console.log("move dog");
          let tempChar2 = currentAgent;
          console.log(tempChar2);
          ...
          if (direction == 0) {
            ...
            arrayOfAgents[x][y + 1] = tempChar2;
            adjustY = 1;
          } else if (direction == 3) {
            arrayOfAgents[x][y - 1] = tempChar2;
            adjustY = -1;
          } else if (direction == 4) {
            arrayOfAgents[x - 1][y + 1] = tempChar2;
          } else if (direction == 5) {
            arrayOfAgents[x + 1][y + 1] = tempChar2;
          } else if (direction == 6) {
            arrayOfAgents[x - 1][y - 1] = tempChar2;
        ...
        switch (tempArrow) {
          case "\u2197":
            if (x + 1 == tempArray.length - 1) {
              player.play("xylophone", x, y);
            } else if (y - 1 == -1) {
              player.play("guitar", x, y);
            } else {
              if (arrayOfBoxes[x + 1][y - 1] != false) {
                arrayOfBoxes[x + 1][y - 1] = arrow_default(tempArrow, arrayOfBoxes[x + 1][y - 1]);
              } else {
          ...
          case "\u2196":
            ...
            if (x - 1 == -1) {
              player.play("banjo", x, y);
            } else if (y - 1 == -1) {
              player.play("marimba", x, y);
            } else {
              if (arrayOfBoxes[x - 1][y - 1] != false) {
                arrayOfBoxes[x - 1][y - 1] = arrow_default(tempArrow, arrayOfBoxes[x - 1][y - 1]);
              } else {
          ...
          case "\u2199":
            if (x - 1 == -1) {
              player.play("banjo", x, y);
            } else if (y + 1 == tempArray.length - 1) {
              player.play("marimba", x, y);
            } else {
              if (arrayOfBoxes[x - 1][y + 1] != false) {
                arrayOfBoxes[x - 1][y + 1] = arrow_default(tempArrow, arrayOfBoxes[x + 1][y - 1]);
          ...
          case "\u2190":
            ...
            if (x - 1 == -1) {
              ...
              if (arrayOfBoxes[x - 1][y] != false) {
                console.log(arrow_default("\u2191", "\u2192"));
                arrayOfBoxes[x - 1][y] = arrow_default(tempArrow, arrayOfBoxes[x - 1][y]);
              } else {
          ...
          case "\u2193":
            ...
            if (y + 1 == tempArray.length - 1) {
              ...
              if (arrayOfBoxes[x][y + 1] != false) {
                ...
                console.log(arrow_default("\u2191", "\u2192"));
                arrayOfBoxes[x][y + 1] = arrow_default(tempArrow, arrayOfBoxes[x][y + 1]);
              } else {
...
var mouseCoordinate = [false, false];
...
var blockBtns = document.getElementsByClassName("block");
